'''This code is from Dawson et al, submitted'''
...
parser.add_argument('--dataset', type=str, default="carbonate_cores", help='Dataset you are using.')
...
parser.add_argument('--model', type=str, default="InceptionV3", help='Your pre-trained classification model of choice')
...
if args.model == "VGG16":
    ...
    ValueError("The model you requested is not available in this study.")
